...
class WXR_Parser_XML {
	 ...
	 *
	 * @param resource $parser Unused, but required as this function is a callback for `xml_set_element_handler()`.
	...
	/**
	 * XML Set Character Data Handler callback.
	 *
	 * @param resource $parser Unused, but required as this function is a callback
	 *                         for `xml_set_character_data_handler()`.
	 * @param string   $cdata  Data.
	 */
	...
	/**
	 * XML Close Element Handler callback.
	 *
	 * @param resource $parser Unused, but required as this function is a callback for `xml_set_element_handler()`.
	 * @param string   $tag    Element name.
	 */
